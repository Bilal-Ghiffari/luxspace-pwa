...
export default function ArrivedItems({items}) {
  return (
        ...
        <div className="rounded-xl overflow-hidden card-shadow relative" style={{width: "287px", height: "386px"}}>
            <div
                    ...
                    <div className="bg-white text-black rounded-full w-16 h-16 flex items-center justify-center">
                        <svg className="fill-current" width="43" height="24" viewBox="0 0 43 24" fill="none"
                    ...
                    <img src={items.image1} alt="" className="w-full h-full object-cover object-center" />
        </div>
                <h5 className="text-lg font-semibold mt-4">{items.name ?? "not-found"}</h5>
                <span className="">{numberFormat(items.price)}</span>
                </Link>
    </div>
  )
}
