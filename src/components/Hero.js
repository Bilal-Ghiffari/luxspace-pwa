    ...
    return (
        <section className="flex items-center hero">
            ...
            <div>
                ...
                className="bg-pink-400 text-black hover:bg-black hover:text-pink-400 rounded-full px-8 py-3 mt-4 inline-block flex-none transition duration-200">Explore
                Now</a>
            </div>
            </div>
            ...
            <div className="relative hero-image">
                ...
                <button type='button' className="video hero-cta focus:outline-none z-30 modal-trigger" onClick={handleShowModal}>
