        ...
        <section className="">
            ...
            <aside className="container mx-auto">
                ...
                <div className="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
                    ...
                    <li>
                        <a href="/" className="hover:underline py-1 block">Privacy Policy</a>
                    </li>
                    <li>
                        <a href="/" className="hover:underline py-1 block">For Developer</a>
                    </li>
                    </ul>
                </div>
                <div className="px-4 w-full md:w-3/12 mb-4 md:mb-0">
                    ...
                    <label className="relative w-full">
                        <input type="text" className="bg-gray-100 rounded-xl py-3 px-5 w-full focus:outline-none"
